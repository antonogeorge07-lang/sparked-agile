  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { opacity: "1", boxShadow: "0 0 20px hsl(221 83% 53% / 0.3)" },
          "50%": { opacity: "0.8", boxShadow: "0 0 40px hsl(221 83% 53% / 0.5)" },
        },
        "gradient-shift": {
      ...
      animation: {
        ...
        "apple-rise": "apple-rise 0.6s cubic-bezier(0.22, 1, 0.36, 1) forwards",
        "apple-scale-in": "apple-scale-in 0.5s cubic-bezier(0.22, 1, 0.36, 1) forwards",
