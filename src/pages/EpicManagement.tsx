...
import { ValueTagDialog } from "@/components/epic/ValueTagDialog";
...
export default function EpicManagement() {
  ...
  const [valueTagEpicId, setValueTagEpicId] = useState<string | null>(null);
    ...
    <>
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          ...
                          <Button
                            ...
                            onClick={(e) => { e.stopPropagation(); setValueTagEpicId(epic.id); }}
                          >
      ...
      {valueTagEpicId && (() => {
        ...
        return (
          <ValueTagDialog
            open={!!valueTagEpicId}
            onOpenChange={(o) => { if (!o) setValueTagEpicId(null); }}
            entityType="epic"
            entityId={valueTagEpicId}
