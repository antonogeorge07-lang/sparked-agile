        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Help us build the Spark-Agile community by letting us feature your workspace name on our public landing page.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-between p-4 bg-muted/40 rounded-lg">
                <div className="pr-4">
                  <p className="font-medium text-sm">Feature our workspace publicly</p>
                  <p className="text-xs text-muted-foreground mt-0.5">
                    We will display only your workspace name. No data, no logos, no PII. You can turn this off anytime.
                  </p>
                </div>
                <Switch
                  checked={!!workspace?.featured}
                  onCheckedChange={async (checked) => {
                    const result = await updateWorkspace({ featured: checked });
                    if (result?.success) {
                      toast({ title: checked ? "Thank you!" : "Updated", description: checked ? "Your workspace will appear in the public showcase." : "Removed from public showcase." });
                    } else {
