...
50% Less Overhead. 100% More Impact. AI-Powered Agility for Modern Teams.50%
with AI-Powered Agile Management<span className="bg-gradient-primary bg-clip-text text-transparent">50%</span>
...
Go from 3-hour planning sessions to 30 minutes.<span className="block mt-3 text-foreground font-semibold">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center pt-2 px-4 animate-in slide-in-from-bottom duration-1000 delay-500">
              <Link to="/auth" className="w-full sm:w-auto">
                <Button size="lg" className="gap-2 w-full sm:w-auto shadow-lg hover:shadow-xl transition-shadow" onClick={() => trackButtonClick('Start Free Today', 'hero')} aria-label="Start free with SAAI today">
                  Start Free Today
            ...
            <div className="mt-4 text-center animate-in fade-in duration-1000 delay-700">
              <button onClick={onEarlyAccess} className="text-sm text-primary hover:underline inline-flex items-center gap-1 font-medium" aria-label="Sign up for early access to premium features">
