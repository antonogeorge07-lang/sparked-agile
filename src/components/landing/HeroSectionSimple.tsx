...
export function HeroSectionSimple() {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center py-20 md:py-28 px-4 overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="container relative mx-auto max-w-5xl z-10">
        <div className="text-center space-y-8">
          ...
          >
            ...
            <motion.span 
              className="block mt-4 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium text-muted-foreground"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
