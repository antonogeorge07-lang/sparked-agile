  ...
  const createDemoProject = async () => {
    ...
    try {
      ...
      const demoTeamMembers = [
        { name: "Sarah Chen", email: "sarah@demo.com", role: "Scrum Master" },
        { name: "Michael Rodriguez", email: "michael@demo.com", role: "Developer" },
        { name: "Emily Watson", email: "emily@demo.com", role: "Product Owner" },
        { name: "James Kim", email: "james@demo.com", role: "Developer" },
        { name: "Lisa Anderson", email: "lisa@demo.com", role: "QA Engineer" }
      ];
      ...
      const { data: valueStream } = await supabase
        .from("value_streams")
        .insert({
          project_id: project.id,
  ...
  return (
    <>
      <Button 
        ...
        variant="outline" 
        size="lg"
        className="gap-2 border-2 border-primary/20 hover:border-primary/40 bg-gradient-to-r from-primary/5 to-primary/10"
      >
