...
export const AIAssistant = () => {
  ...
  // Auto-scroll to the latest message. Radix ScrollArea renders an inner
  // viewport element; we must scroll that, not the outer wrapper.
  useEffect(() => {
    ...
    // Use rAF so DOM has painted the new message before we scroll.
    requestAnimationFrame(() => {
      target.scrollTop = target.scrollHeight;
    });
  }, [messages, isTyping, isLoadingHistory, isOpen]);
